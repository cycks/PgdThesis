...
mrvl_cleanUrl.startsWith("https://link.springer.com/chapter/")) {
  ...
  var incoming = {
      ...
      mpn: ctl.productid || "",
      link: "https://www.kqzyfj.com/click-8914956-13091548?url=" + encodeURIComponent(ctl.location.split("?")[0]),
...
else if(mrvl_cleanUrl.startsWith("https://order.springer.com/public/login") || mrvl_cleanUrl.startsWith("https://order.springer.com/public/address") || mrvl_cleanUrl.startsWith("https://order.springer.com/public/verify") ||
mrvl_cleanUrl.startsWith("https://order-payment.springer.com/payment")) {
  ctl.cls = "checkout";
  // leave this line here
}
else if (mrvl_cleanUrl.startsWith("https://order.springer.com/public/cart")) {
  ctl.cls = "cart";
  // leave this line here
}
else if (mrvl_cleanUrl.startsWith("https://order.springer.com/public/thankyou")) {
...
ctls.src = 'https://s.marvellousmachine.net/ctl?' + queryString + '&psk=558708196239';
