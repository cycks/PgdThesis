...
try:
    ...
    if not os.path.exists(extraction_dir):
        if os.path.exists(zip_filename):
            ...
            print(f"CRITICAL ERROR: {extraction_dir} folder and {zip_filename} not found.")
            sys.exit(1)
    else:
    ...
    def train_and_evaluate(model, epochs=10):
        ...
        plt.title('Cycks with Padding Confusion Matrix')
        ...
        plt.title('Cycks with Padding Multiclass ROC Curve')
