...
# --- LOGGING SETUP ---
log_file_path = "Reduced_cycks_With_Padding_Log.txt"
...
def save_performance_plots(history):
    ...
    plt.savefig('Reduced_cycks_with_padding_accuracy_loss_plots.png')
    print("Saved Reduced_cycks_with_padding_accuracy_loss_plots.png")
...
def save_roc_curve(y_true, y_probs, num_classes):
    ...
    plt.legend(loc="lower right")
    plt.savefig('Reduced_cycks_with_padding_roc_curve.png')
