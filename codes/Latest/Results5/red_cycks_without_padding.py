...
# --- LOGGING SETUP ---
log_file_path = "Reduced_cycks_Without_Padding_1_Log.txt"
...
def create_model(num_classes, input_shape=(256, 256, 3)):
    model = models.Sequential(name="Reduced_Cycks_Without_Padding")
...
def save_performance_plots(history):
    ...
    plt.title('Training and Validation Accuracy for Reduced cycks Without Padding')
    ...
    plt.title('Training and Validation Loss for Reduced cycks Without Padding')
    plt.legend(loc='upper right')
    
    plt.savefig('Reduced_cycks_without_padding_1_accuracy_loss_plots.png')
    print("Saved Reduced_cycks_without_padding_1_accuracy_loss_plots.png")
...
def save_roc_curve(y_true, y_probs, num_classes):
    ...
    plt.title('Multi-class ROC Curve for Reduced cycks Without Padding')
    plt.legend(loc="lower right")
    plt.savefig('Reduced_cycks_without_padding_1_roc_curve.png')
